...
func OK(msg string, data interface{}) Response {
	return succes(msg, data, http.StatusOK)
}
func Created(msg string, data interface{}) Response {
	return succes(msg, data, http.StatusCreated)
}
func Accepted(msg string, data interface{}) Response {
	return succes(msg, data, http.StatusAccepted)
}
func NonAuthoritativeInfo(msg string, data interface{}) Response {
	return succes(msg, data, http.StatusNonAuthoritativeInfo)
}
func NoContent(msg string, data interface{}) Response {
	return succes(msg, data, http.StatusNoContent)
}
func ResetContent(msg string, data interface{}) Response {
	return succes(msg, data, http.StatusResetContent)
}
func PartialContent(msg string, data interface{}) Response {
	return succes(msg, data, http.StatusPartialContent)
}

func succes(msg string, data interface{}, code int) Response {
